...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference("Ingredient.count") do
      post ingredients_url, params: { ingredient: { food_id: @ingredient.food_id, grams: @ingredient.grams, meal_id: @ingredient.meal_id } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { food_id: @ingredient.food_id, grams: @ingredient.grams, meal_id: @ingredient.meal_id } }
