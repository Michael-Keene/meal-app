...
class FoodConsumptionEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create food_consumption_event' do
    assert_difference('FoodConsumptionEvent.count') do
      post food_consumption_events_url,
           params: { food_consumption_event: { food_id: @food_consumption_event.food_id, grams: @food_consumption_event.grams,
                                               user_id: @food_consumption_event.user_id } }
    end
  ...
  test 'should update food_consumption_event' do
    patch food_consumption_event_url(@food_consumption_event),
          params: { food_consumption_event: { food_id: @food_consumption_event.food_id, grams: @food_consumption_event.grams,
                                              user_id: @food_consumption_event.user_id } }
