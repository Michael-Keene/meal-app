...
class MealConsumptionEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meal_consumption_event" do
    assert_difference("MealConsumptionEvent.count") do
      post meal_consumption_events_url, params: { meal_consumption_event: { meal_id: @meal_consumption_event.meal_id, user_id: @meal_consumption_event.user_id } }
    end
  ...
  test "should update meal_consumption_event" do
    patch meal_consumption_event_url(@meal_consumption_event), params: { meal_consumption_event: { meal_id: @meal_consumption_event.meal_id, user_id: @meal_consumption_event.user_id } }
